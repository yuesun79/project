		...
		<figure>
	        ...
	        <figcaption>
                ...
                <p class="differButtons">
                    <input type="button" value="修改" class="another-button" data-imageid="${pic.imageID }" data-url="${pageContext.request.contextPath }/modifyServlet"
                     data-path="${pic.path }">
                    <input class="delete" type="button" value="删除"  
                    data-imageid="${pic.imageID }" data-user="${pic.UID }" data-url="${pageContext.request.contextPath }/deleteMyPhotoServlet" data-baseurl="${pageContext.request.contextPath }">
                </p>
	        </figcaption>
        </figure>
	</c:forEach>
...
<div class="page">
    <ul class="pagination" id="page" data-pagetype="my">
        <li class="arrows"><a href="#" class="singlePage" id="prev" data-page="1"
        data-url="${pageContext.request.contextPath}/myPhotoServlet" data-baseurl="${pageContext.request.contextPath}"> << </a></li>
        <c:forEach var="i" begin="1" end="${requestScope.totalpage }">
        	<li><a class="singlePage" href="#" 
        	data-page="${i }" data-url="${pageContext.request.contextPath}/myPhotoServlet" data-baseurl="${pageContext.request.contextPath}">${i }
        	</a></li>
        </c:forEach>
...
<script src="${pageContext.request.contextPath}/js/deleteMyPhoto.js"></script> 
